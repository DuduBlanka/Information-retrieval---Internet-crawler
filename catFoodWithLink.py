...
while page <= max_pages:
    ...
    url = 'https://www.anipet.co.il/Cat/0/?keyword=%D7%9E%D7%96%D7%95%D7%9F+%D7%9C%D7%97%D7%AA%D7%95%D7%9C'
    data = {'q': 'מזון לחתול', 'page': page}
...
with open('CatsProductsWeight.csv', 'w', encoding='utf-8-sig', newline='') as csv_file:

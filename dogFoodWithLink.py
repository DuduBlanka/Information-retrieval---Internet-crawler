...
while page <= max_pages:
    ...
    url = 'https://www.anipet.co.il/Cat/0/?keyword=%D7%9E%D7%96%D7%95%D7%9F+%D7%9C%D7%9B%D7%9C%D7%91'
    data = {'q': 'מזון לכלב', 'page': page}
...
with open('DogProdcutsWeight.csv', 'w', encoding='utf-8-sig', newline='') as csv_file:
